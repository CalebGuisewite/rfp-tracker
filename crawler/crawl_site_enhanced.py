...
def is_javascript_error_page(content):
    """Detect if the page is a JavaScript error page"""
    error_indicators = [
...
def get_page_content(url, session):
    ...
    try:
        ...
        if 'text/html' in content_type:
            ...
            # Check if this is a JavaScript error page
            if is_javascript_error_page(extracted_text):
                print(f"  ⚠️ JavaScript error page detected for {url}")
                return ""
